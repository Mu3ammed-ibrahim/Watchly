...
import { fetchSearchMovies } from '../redux/features/movies/moviesSlice';
      ...
      <div className="min-h-screen bg-[#141414] text-white pt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">Please enter at least 3 characters to search for movies.</p>
            <button
              onClick={() => navigate('/')}
              className="bg-[#e50914] hover:bg-[#b8070f] px-6 py-3 rounded-lg transition-colors"
            >
        ...
        {error && !searchLoading && (
          <div className="text-center py-20">
            <div className="text-red-500 mb-4">
              ...
              <p className="text-gray-400">There was an error searching for movies. Please try again.</p>
            </div>
            <button
          ...
          <>
            ...
            >
              {currentMovies.map((movie, index) => (
                ...
                >
                  <div className="relative overflow-hidden rounded-lg bg-gray-800 aspect-[2/3] group-hover:scale-105 transition-transform duration-300">
                    {movie.poster_path ? (
                      <img
                      ...
                      <div className="p-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="flex items-center mb-2">
                          {movie.vote_average > 0 && (
                            <div className="flex items-center bg-black bg-opacity-50 rounded px-2 py-1">
